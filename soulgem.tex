...
We proposed that expectations are clustered in roles based on a combination of institutional, historical, structural, and personal factors. Our empirical evidence provided support for this proposition, as detailed below.

\emph{Institutional factors:} The larger culture plays an important part in shaping the expectations of members of software organizations. For example, when Gallium hired one of its Product Managers, he had significant domain expertise, but no software development experience. He initially struggled to satisfy the expectations placed on him. (...)

\emph{Historical factors:}

\emph{Structural factors:}

\emph{Personal factors:}
